...
INSERT INTO users (username, email, password, about)
VALUES ('admin', 'admin@example.com', '123456', 'Admin account');
...
CREATE TABLE IF NOT EXISTS contacts (
    ...
    link_img VARCHAR(255) DEFAULT '/imgA/avatarDefault.png',
    groups_ln JSON DEFAULT JSON_ARRAY('Người lạ'),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);

INSERT INTO contacts (user_id, name, phone, email, note, created_at) VALUES
(1, 'Pham Anh Dung', '0905123789', 'dungpham123@gmail.com', 'Friend in Cau Giay', '2025-01-12 09:15:42'),
(1, 'Nguyen Minh Hai', '0987421653', 'minhhai567@gmail.com', 'Friend in Dong Da', '2025-02-03 14:22:10'),
(1, 'Tran Quoc Huy', '0978654312', 'huytran99@gmail.com', 'Friend in Ben Nghe', '2025-02-17 18:47:22'),
(1, 'Le Nhat Hao', '0912348756', 'haole123@gmail.com', 'Friend in Cau Tre', '2025-03-05 10:31:55'),
(1, 'Nguyen Van Tam', '0945321786', 'tamnguyen321@gmail.com', 'Friend in An Cu', '2025-03-18 11:42:20');
...
INSERT INTO ggroups (user_id, name, color, created_at)
VALUES
(1, 'Người lạ', '#808080', NOW()),
(1, 'Người thân', '#FF0000', NOW()),
(1, 'Khách hàng', '#00FF00', NOW()),
(1, 'Sếp', '#0000FF', NOW()),
(1, 'Đồng nghiệp', '#FF8C00', NOW())
